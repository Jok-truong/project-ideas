...
const SomethingIveBuilt = () => {
  ...
  return (
    ...
    >
      <div className=" flex flex-row  items-center md:px-0 xl:mb-24">
        <ArrowIcon
          className={
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left md:text-right ">
                  ...
                  ,{" "}
                  <span className="text-AAsecondary">
                    Smartos Marketplace application and White Label platform{" "}
                  </span>
                </p>
              </div>
              <ul
            ...
            >
              ...
              <div className="w-full md:bg-AAtertiary rounded-md py-6 md:p-6  z-10">
                <p className="text-gray-300 md:text-gray-400 text-left ">
                  A{" "}
                  <span className="text-AAsecondary text-base">
                    webapp project providing room rental management services{" "}
                  </span>
                </p>
              </div>
              <ul
              ...
              >
                ...
                <span className="pr-4 z-10">TypeScript</span>
                <span className="pr-4 z-10">Gahpql</span>
                <span className="pr-4 z-10">Ant</span>
              </ul>
            </div>
          </div>
        </div>
